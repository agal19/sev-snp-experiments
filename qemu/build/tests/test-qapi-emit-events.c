...
const QEnumLookup test_QAPIEvent_lookup = {
    .array = (const char *const[]) {
        ...
        [TEST_QAPI_EVENT_TEST_IF_EVENT] = "TEST_IF_EVENT",
        [TEST_QAPI_EVENT_TEST_IF_EVENT2] = "TEST_IF_EVENT2",
        [TEST_QAPI_EVENT_TEST_EVENT_FEATURES0] = "TEST_EVENT_FEATURES0",
        [TEST_QAPI_EVENT_TEST_EVENT_FEATURES1] = "TEST_EVENT_FEATURES1",
    },
