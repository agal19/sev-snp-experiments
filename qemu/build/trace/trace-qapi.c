...
uint16_t _TRACE_VISIT_DEPRECATED_ACCEPT_DSTATE;
uint16_t _TRACE_VISIT_DEPRECATED_DSTATE;
...
TraceEvent _TRACE_VISIT_DEPRECATED_ACCEPT_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "visit_deprecated_accept",
    .sstate = TRACE_VISIT_DEPRECATED_ACCEPT_ENABLED,
    .dstate = &_TRACE_VISIT_DEPRECATED_ACCEPT_DSTATE 
};
TraceEvent _TRACE_VISIT_DEPRECATED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "visit_deprecated",
    .sstate = TRACE_VISIT_DEPRECATED_ENABLED,
    .dstate = &_TRACE_VISIT_DEPRECATED_DSTATE 
};
...
TraceEvent *qapi_trace_events[] = {
    ...
    &_TRACE_VISIT_DEPRECATED_ACCEPT_EVENT,
    &_TRACE_VISIT_DEPRECATED_EVENT,
