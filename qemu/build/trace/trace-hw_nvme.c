...
uint16_t _TRACE_PCI_NVME_DIF_PRACT_GENERATE_DIF_DSTATE;
uint16_t _TRACE_PCI_NVME_DIF_CHECK_DSTATE;
uint16_t _TRACE_PCI_NVME_DIF_PRCHK_DISABLED_DSTATE;
uint16_t _TRACE_PCI_NVME_DIF_PRCHK_GUARD_DSTATE;
uint16_t _TRACE_PCI_NVME_DIF_PRCHK_APPTAG_DSTATE;
uint16_t _TRACE_PCI_NVME_DIF_PRCHK_REFTAG_DSTATE;
...
TraceEvent _TRACE_PCI_NVME_DIF_PRACT_GENERATE_DIF_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_dif_pract_generate_dif",
    .sstate = TRACE_PCI_NVME_DIF_PRACT_GENERATE_DIF_ENABLED,
    .dstate = &_TRACE_PCI_NVME_DIF_PRACT_GENERATE_DIF_DSTATE 
};
...
TraceEvent _TRACE_PCI_NVME_DIF_PRCHK_DISABLED_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_dif_prchk_disabled",
    .sstate = TRACE_PCI_NVME_DIF_PRCHK_DISABLED_ENABLED,
    .dstate = &_TRACE_PCI_NVME_DIF_PRCHK_DISABLED_DSTATE 
};
TraceEvent _TRACE_PCI_NVME_DIF_PRCHK_GUARD_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_dif_prchk_guard",
    .sstate = TRACE_PCI_NVME_DIF_PRCHK_GUARD_ENABLED,
    .dstate = &_TRACE_PCI_NVME_DIF_PRCHK_GUARD_DSTATE 
};
...
TraceEvent _TRACE_PCI_NVME_DIF_PRCHK_REFTAG_EVENT = {
    .id = 0,
    .vcpu_id = TRACE_VCPU_EVENT_NONE,
    .name = "pci_nvme_dif_prchk_reftag",
    .sstate = TRACE_PCI_NVME_DIF_PRCHK_REFTAG_ENABLED,
    .dstate = &_TRACE_PCI_NVME_DIF_PRCHK_REFTAG_DSTATE 
};
...
TraceEvent *hw_nvme_trace_events[] = {
    ...
    &_TRACE_PCI_NVME_DIF_PRACT_GENERATE_DIF_EVENT,
    &_TRACE_PCI_NVME_DIF_CHECK_EVENT,
    &_TRACE_PCI_NVME_DIF_PRCHK_DISABLED_EVENT,
    &_TRACE_PCI_NVME_DIF_PRCHK_GUARD_EVENT,
    &_TRACE_PCI_NVME_DIF_PRCHK_APPTAG_EVENT,
    &_TRACE_PCI_NVME_DIF_PRCHK_REFTAG_EVENT,
