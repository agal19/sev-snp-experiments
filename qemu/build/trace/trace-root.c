...
uint16_t _TRACE_GUEST_LD_BEFORE_TRANS_DSTATE;
uint16_t _TRACE_GUEST_LD_BEFORE_EXEC_DSTATE;
uint16_t _TRACE_GUEST_ST_BEFORE_TRANS_DSTATE;
uint16_t _TRACE_GUEST_ST_BEFORE_EXEC_DSTATE;
uint16_t _TRACE_GUEST_RMW_BEFORE_TRANS_DSTATE;
uint16_t _TRACE_GUEST_RMW_BEFORE_EXEC_DSTATE;
...
TraceEvent _TRACE_GUEST_LD_BEFORE_TRANS_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_ld_before_trans",
    .sstate = TRACE_GUEST_LD_BEFORE_TRANS_ENABLED,
    .dstate = &_TRACE_GUEST_LD_BEFORE_TRANS_DSTATE 
};
TraceEvent _TRACE_GUEST_LD_BEFORE_EXEC_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_ld_before_exec",
    .sstate = TRACE_GUEST_LD_BEFORE_EXEC_ENABLED,
    .dstate = &_TRACE_GUEST_LD_BEFORE_EXEC_DSTATE 
};
TraceEvent _TRACE_GUEST_ST_BEFORE_TRANS_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_st_before_trans",
    .sstate = TRACE_GUEST_ST_BEFORE_TRANS_ENABLED,
    .dstate = &_TRACE_GUEST_ST_BEFORE_TRANS_DSTATE 
};
TraceEvent _TRACE_GUEST_ST_BEFORE_EXEC_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_st_before_exec",
    .sstate = TRACE_GUEST_ST_BEFORE_EXEC_ENABLED,
    .dstate = &_TRACE_GUEST_ST_BEFORE_EXEC_DSTATE 
};
TraceEvent _TRACE_GUEST_RMW_BEFORE_TRANS_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_rmw_before_trans",
    .sstate = TRACE_GUEST_RMW_BEFORE_TRANS_ENABLED,
    .dstate = &_TRACE_GUEST_RMW_BEFORE_TRANS_DSTATE 
};
TraceEvent _TRACE_GUEST_RMW_BEFORE_EXEC_EVENT = {
    .id = 0,
    .vcpu_id = 0,
    .name = "guest_rmw_before_exec",
    .sstate = TRACE_GUEST_RMW_BEFORE_EXEC_ENABLED,
    .dstate = &_TRACE_GUEST_RMW_BEFORE_EXEC_DSTATE 
};
...
TraceEvent *root_trace_events[] = {
    ...
    &_TRACE_GUEST_LD_BEFORE_TRANS_EVENT,
    &_TRACE_GUEST_LD_BEFORE_EXEC_EVENT,
    &_TRACE_GUEST_ST_BEFORE_TRANS_EVENT,
    &_TRACE_GUEST_ST_BEFORE_EXEC_EVENT,
    &_TRACE_GUEST_RMW_BEFORE_TRANS_EVENT,
    &_TRACE_GUEST_RMW_BEFORE_EXEC_EVENT,
