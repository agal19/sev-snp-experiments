...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xE750224E, 0x7BCE, 0x40AF, {0xB5, 0xBB, 0x47, 0xE3, 0x61, 0x1E, 0xB5, 0xC2}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "TdxDxe";
...
// Protocols
GLOBAL_REMOVE_IF_UNREFERENCED EFI_GUID gQemuAcpiTableNotifyProtocolGuid = {0x928939b2, 0x4235, 0x462f, {0x95, 0x80, 0xf6, 0xa2, 0xb2, 0xc2, 0x1a, 0x4f}};
...
{
  return TdxDxeEntryPoint (ImageHandle, SystemTable);
}
