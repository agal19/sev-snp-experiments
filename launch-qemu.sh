...
#TMP="/home/rrkapitz/AMDSEVv6/usr/local/bin/qemu-system-x86_64"
TMP="/home/anna/AMDSEV/usr/local/bin/qemu-system-x86_64"
...
#add_opts "-drive file=/home/anna/build-snp-vm/sev-guest-cloud-config.img,format=raw"
#add_opts "-drive file=/home/rrkapitz/build-snp-vm/sev-guest-cloud-config.img,format=raw"
